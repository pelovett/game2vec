...
#Default URL is mine
def api_call(start, mid, key, end="", userID="76561197960435530"):
...
def get_player_sum(api_key, user="76561197978184570"):
...
def get_all_games(api_key, user="76561197978184570"):
...
def get_game_name(gameID, api_key):
